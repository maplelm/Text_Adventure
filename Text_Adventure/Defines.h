...
#define AIR_ENTITY    new Entity(AIR_ID,   " ", NO_STATS,COLOR_BLUE,    COLOR_BLUE,  PASSABLE,   VISABLE)
...
#define TREE_ENTITY   new Entity(TREE_ID,  "T", NO_STATS,COLOR_GREEN,   COLOR_NONE,  PASSABLE,   VISABLE)
